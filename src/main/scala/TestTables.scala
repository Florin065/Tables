...
object TestTables {
  ...
  def programmingLanguages1: Table =
    Merge("Language",
          NewCol("Functional",
                 "Yes",
                 Value(tableFunctional)),
          Merge("Language",
                NewCol("Object-Oriented",
                       "Yes",
                       Value(tableObjectOriented)),
                NewCol("Imperative",
                       "Yes",
                       Value(tableImperative)))).eval.get


  // 3.2
  val programmingLanguages2: Table =
    Filter(And(Field("Original purpose",
                     _.contains("Application")),
               Field("Other paradigms",
                     _.contains("concurrent"))),
